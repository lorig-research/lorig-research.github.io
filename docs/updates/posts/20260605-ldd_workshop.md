...
The first workshop will focus on linguistic fieldwork, including data collection, research ethics, recording practices, data storage, phonetics and phonology, orthographies, and the International Phonetic Alphabet (IPA).

Applications are open to participants from Bhutan, India, Nepal, Bangladesh, and Pakistan. The application deadline is **15 August 2026**, with acceptance communicated by **15 September 2026**.

For full details, including eligibility, funding support, workshop planning, and application information, please see the official announcement:

[Download the workshop announcement PDF](/assets/files/updates/20260605-ldd_workshop/Lo-Rig_LDD-Workshop-01_Announcement.pdf)
